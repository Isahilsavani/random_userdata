...
MultipleData multipleDataFromJson(String str) => MultipleData.fromJson(json.decode(str));

String multipleDataToJson(MultipleData data) => json.encode(data.toJson());
...
class MultipleData {
  ...
  factory MultipleData.fromJson(Map<String, dynamic> json) => MultipleData(
